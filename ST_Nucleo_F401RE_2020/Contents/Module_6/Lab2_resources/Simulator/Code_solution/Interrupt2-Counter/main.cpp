/*----------------------------------------------------------------------------
LAB EXERCISE 6.2 - INTERRUPT IN/OUT - Counters
...
Also, if several buttons have been pressed the same number of times their respect LEDs should all be ON simultaneously. 
